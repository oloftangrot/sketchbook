...
#define FQ_UD 6  // connected to AD9850 device select pin
#define W_CLK 13  // connected to AD9850 clock pin
#define DATA 11   // connected to AD9850 D7 (serial data) pin
