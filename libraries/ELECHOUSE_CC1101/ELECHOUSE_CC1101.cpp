...
void ELECHOUSE_CC1101::SpiInit( void )
{
  ...
  SpiMode(0);   // enable SPI Master, MSB, SPI mode 0, FOSC/4
#else // This section is for Arduino Leonardo using the SPI API.
  SPI.begin();
  pinMode( SS_PIN, OUTPUT );
...
void ELECHOUSE_CC1101::Init(void)
{
	...
	GDO_Set();				//GDO set
	digitalWrite(SS_PIN, HIGH);
#if 0   // Not used on Arduino Leonardo.
