...
//.kbv #include <Adafruit_TFTLCD.h> // Hardware-specific library
...
//.kbv #define SD_CS 5 // Card select for shield use
#define SD_CS 10 // Card select for shield use

//.kbv Adafruit_TFTLCD tft;
...
void setup()
{
  ...
  } else if(identifier == 0x0154) {   //.kbv extra chips:
