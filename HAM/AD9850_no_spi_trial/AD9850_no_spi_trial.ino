/*
 * A simple AD9850 Arduino script - non SPI version
...
#define FQ_UD 8  // connected to AD9850 device select pin
#define W_CLK 9  // connected to AD9850 clock pin
#define DATA 10   // connected to AD9850 D7 (serial data) pin
